...
\textbf{Setup:} DTA-2116 \gls{RF} output connected to a % TODO: nome/modelo do frequency counter
frequency counter.
...
% TODO: detalhar ferramenta/comando de captura, fornecido pela FFVD
& Recorded \gls{I/Q} file is produced. \\
\hline
3 & Compare the recorded signal against the original test vector.
% TODO: detalhar método de comparação (correlação? decodificação?), fornecido pela FFVD
