...
It allows for long-distance communication and is resistant to electrical noise, making it ideal for use in environments where electromagnetic interference is present.\cite{wikipediaRS485}
...
In this phase, the focus will be on developing the \gls{RS485} communication
interface for the GNSS signal generator. This will involve creating an API that
allows users to interact with external equipment via the \gls{RS485} interface.
...
\begin{itemize}
      \item Acquire working knowledge of the target \gls{SDR} hardware architecture and its
            interface.
      \item Understand \gls{RS485} communication protocol and its application in instrument
            control.
      ...
      \item Implement \gls{RS485} communication layer for exchange of commands and data
...
complexity of the SDR architecture and the RS-485 communication protocol were
also acknowledged.
