...
\newglossaryentry{rs232-interface}{
  ...
  description={The \gls{RS232} interface is the secondary software component developed in this internship. It is responsible for data enconding and deconding as well as its transmission and reception through the \gls{RS232} physical layer. It is used for intercommunication of pre-existing components.}
} 