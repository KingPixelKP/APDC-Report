...
\newglossaryentry{rs232-interface}{
  ...
  description={The \gls{RS232} interface is the secondary connectivity component developed in this work. It establishes a \gls{PPP} link over the \gls{RS232} physical layer so that higher-level services, namely gRPC, can communicate through a standard IP channel.}
}
