...
\ntaddfile{chapter}{chapter-state-of-the-art}
\ntaddfile{chapter}{chapter-sdr-control-interface}
\ntaddfile{chapter}{chapter-rs232-interface}
\ntaddfile{chapter}{chapter-integration-testing}
\ntaddfile{chapter}{chapter-conclusion-retrospective}
...
%-------------------------------------------------------------
\ntaddfile{appendix}{appendix-design-patterns}
