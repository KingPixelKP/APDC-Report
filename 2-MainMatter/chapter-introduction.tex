...
not explicitly represented in either table. \textcolor{Red}{TODO the second
...
As the developed components matured, it became necessary to integrate them
with existing proprietary systems at \gls{GMV} that had not been part of the
