...
interface is not user-friendly, due to its requirement to chain calls correcly
the heavy use of macros, manual device state management and it does not offer a
...
To note that an undesired, but useful nonetheless, feature of this architecture
is that it allows users to create \textit{bash} scripts that can interact with
the system through the client executable, which can be useful for quick testing
