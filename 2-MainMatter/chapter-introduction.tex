...
share similar framing and command structures, the impact on the implementation
was minimal, requiring only adjustments to the physical layer configuration.
...
It is also worth noting that the original internship proposal referred to the
serial interface as \gls{RS485}. This was a misnomer in the proposal
document: the external equipment in use at \gls{GMV} communicated over
\gls{RS232} from the outset, and no requirement or design decision was
actually changed. As this was identified before any protocol-specific
implementation work took place, it had no impact on the development of the
\gls{RS232} interface described in this report.