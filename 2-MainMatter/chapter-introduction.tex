...
GNSS signal generator \textcolor{Red}{And transmitter} at a high level, without
needing to understand the low-level details of the hardware. The API will
provide functions for configuring the signal generator, starting and stopping
signal generation, and monitoring the status of the generator.
\textcolor{Red}{it shall also provide functions to control the transmitter,
    such as starting and stopping transmission, and monitoring the status of the
    devices.}
...
GNSS signal generator \textcolor{Red}{and transmitter}. This will enable users
to quickly and efficiently set up their test scenarios, without having to
manually adjust each parameter through low-level API calls.
