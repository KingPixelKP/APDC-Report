...
A useful, though unintended, feature of this
...
user-friendly build system, which allows for a more concise and easier-to-maintain
build configuration, as well as an extremely easy-to-use package
...
\gls{SDR} hardware, though this cannot really be considered a problem as those
