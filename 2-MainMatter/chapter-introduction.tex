...
GNSS signal generator and transmitter at a high level, without needing to
understand the low-level details of the hardware. The API will provide
functions for configuring the signal generator, starting and stopping signal
generation, and monitoring the status of the generator it shall also provide
functions to control the transmitter, such as starting and stopping
transmission, and monitoring the status of the devices, etc..
