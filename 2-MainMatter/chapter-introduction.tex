...
received by an antenna". \gls{GNSS} simulators are essential for testing and validating \gls{GNSS} receivers as they serve as an easy to use signal source, as they enable
...
simulators may also aid in the testing new types of \gls{GNSS} signal to be used in newer versions of existing systems.
