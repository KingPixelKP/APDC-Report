...
This first chapter serves as a brief introduction to the internship, the problems to be solved and the proposed solutions.
...
\gls{GNSS} are a family of satellite-based positioning systems that provide geolocation and time information to a GPS receiver anywhere on Earth. These systems consist of a network of satellites that transmit signals to receivers, which then use the signals to determine their location.
