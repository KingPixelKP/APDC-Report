...
\newglossaryentry{rs485-interface}{
  name={\gls{RS485} Interface},
  sort={rs485-interface},
  description={The \gls{RS485} interface is the secondary software component developed in this internship. It is responsible for data enconding and deconding as well as its transmission and reception through the \gls{RS485} physical layer. It is used for intercommunication of pre-existing components.}
} 