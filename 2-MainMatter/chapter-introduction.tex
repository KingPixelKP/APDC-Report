...
The internship aims to develop an interface that closes the gap by designing an easy-to-use C++ tool for the programmatic control of a \gls{GNSS} signal generator.
...
This will involve creating a C++ API that allows users to interact with the GNSS signal generator at a high level, without needing to understand the low-level details of the hardware.
The API will provide functions for configuring the signal generator, starting and stopping signal generation, and monitoring the status of the generator.

\emph{Phase 2 Parameter Management:}

In this phase, the focus will be on developing a parameter management system that allows users to easily configure and manage the various parameters of the GNSS signal generator.
