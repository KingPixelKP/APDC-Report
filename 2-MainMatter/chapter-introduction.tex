...
engineers to design and execute their tests. The internship can be split into
three key phases:
...
corresponding dates for each phase of the project.
\begin{table}[htbp]
      \centering
      ...
      \begin{tabular}{|p{3cm}|p{8cm}|c|c|}
            ...
            \hline
            Onboarding and Studying               & Introduction to the signal generator architecture; study of SDR APIs; \gls{RS232} protocol fundamentals; review of existing codebase and tooling at GMVIS Skysoft & 3 weeks  & Mar 11 - Mar 31 \\
            \hline
...
clear, providing a roadmap for the development of the SDR control system and
its integration with external equipment. The possible challenges due to the
complexity of the SDR architecture and the RS-232 communication protocol were
also acknowledged.
