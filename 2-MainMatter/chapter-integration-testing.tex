...
\autoref{sec:design-implementation}, while functioning correctly and
...
described in \autoref{sec:design-implementation}: the gRPC layer
remains functional and independently testable through the CLI
client (\autoref{sec:functionality-use-cases}), and would be
...
(\autoref{sec:objective-motivation}), and the specific
