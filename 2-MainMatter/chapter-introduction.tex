...
generator. This interface will abstract the complexities of hardware
communication and provide a more user-friendly environment for engineers to
design and execute their tests. \textcolor{Red}{Major note that the objectives
      displayed bellow evolved throughout the internship, and the final objectives
      were a result of the evolution of the scope of the project.} The internship can
be split into three key phases:
...
GNSS signal generator at a high level, without needing to understand the
low-level details of the hardware. The API will provide functions for
configuring the signal generator, starting and stopping signal generation, and
monitoring the status of the generator, monitor the state of devices.
...
GNSS signal generator. This will enable users to quickly and efficiently set up
their test scenarios, without having to manually adjust each parameter through
low-level API calls.
...
\begin{table}[htbp]
      ...
      \begin{tabular}{|p{3cm}|p{8cm}|c|c|}
            ...
            \hline
            \gls{\gls{SDR}} Control Modules       & Development of C++ API for \gls{SDR} control; implementation of signal generation functions; integration with vendor API and unit testing                               & 4 weeks  & Apr 01 - Apr 28 \\
            \hline
...
\begin{table}
      ...
      \begin{tabular}{|p{3cm}|p{8cm}|c|c|}
            ...
            \hline
            \gls{\gls{SDR}} Control Modules \& Parameter Management & Development of C++ API for \gls{SDR} control; implementation of signal generation functions; integration with vendor API and unit testing                                                                                         & 8 weeks  & Mar 18 - May 2  \\
            \hline
