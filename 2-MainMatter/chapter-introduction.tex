...
\begin{table}[htbp]
      ...
      \begin{tabular}{|p{3cm}|p{8cm}|c|c|}
            ...
            \hline
            \gls{RS232} Connectivity                                                                &
            Design and implementation of an \gls{RS232}-based communication protocol                                                                 &
            1 week                                                                                   & May 3 -- May 9                                                                                                                                                    \\
            \hline
            ...
            \hline
            Complete Testing Suite, Final Report \& Transition to Extended Work                      & Create a complete testing suite to validate component integration; finalize the report; continue technical documentation; and begin consolidation tasks that transitioned into the continuation phase directly under \gls{GMV} & 4 weeks  & Jun 22 -- Jul 17 \\
            \hline
      \end{tabular}
\end{table}
